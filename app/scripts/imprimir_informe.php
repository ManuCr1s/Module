...
$reclamo = mysqli_query($link,"SELECT nombre_responsable,dni_responsable,detalle_analisis,detalle_resultado,conclusion FROM resultado WHERE id_reclamo = {$_POST['id']}");
$respuesta = mysqli_fetch_all($reclamo,MYSQLI_ASSOC);
$pdf->AddPage();
$pdf->Image('../img/hrdac.png',10,10,60 );
$pdf->Image('../img/susalud.png',140,10,60 );
$pdf->SetFont('Arial','BU',15);
$pdf->Ln(28);
$pdf->Cell(185, 10, 'INFORME DEL RESULTADO ', 0,0,'C');
$pdf->SetFont('Arial','B',8);
$pdf->Ln(15);
$pdf->SetX(30);
$pdf->Cell(150, 11,'DETALLES DEL RESULTADO', 0,0,'C',1);
$pdf->Ln(11);
$pdf->SetFont('Arial','B',7);
$pdf->SetX(30);
$pdf->Cell(30, 11,'CANAL DE INGRESO', 1,0,'C',0);
$pdf->SetFont('Arial','',7);
$pdf->Cell(120, 11,'MEDIANTE EL LIBRO DE RECLAMACIONES VIRTUAL', 1,0,'C',0);
$pdf->Ln(11);
$pdf->SetFont('Arial','B',7);
$pdf->SetX(30);
$pdf->Cell(150, 11,'ANALISIS DEL HECHO', 1,0,'C',0);
$pdf->Ln(11);
$pdf->SetFont('Arial','',7);
$pdf->SetX(30);
$pdf->MultiCell(150,4,utf8_decode($respuesta[0]['detalle_analisis']),1,'J',0);
$pdf->Ln(11);
$pdf->SetFont('Arial','B',7);
$pdf->SetX(30);
$pdf->Cell(30, 11,'CONCLUSION', 1,0,'C',0);
$pdf->SetFont('Arial','',7);
$pdf->Cell(120, 11,utf8_decode($respuesta[0]["conclusion"]), 1,0,'C',0);
$pdf->Ln(11);
$pdf->SetFont('Arial','B',7);
$pdf->SetX(30);
$pdf->Cell(150, 11,'DETALLE DE CONCLUSION DEL RECLAMO O MEDIDAS A OPTAR', 1,0,'C',0);
$pdf->Ln(11);
$pdf->SetFont('Arial','',7);
$pdf->SetX(30);
$pdf->MultiCell(150,4,utf8_decode($respuesta[0]['detalle_resultado']),1,'J',0);
